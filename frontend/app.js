...
function HSeg({ value, options, onPick }) {
  return /* @__PURE__ */ React.createElement("span", { className: "home-seg" }, options.map((o) => /* @__PURE__ */ React.createElement("button", { key: o.v, className: value === o.v ? "on" : "", onClick: () => onPick(o.v) }, o.label)));
}
function HStep({ value, onSet, min, max, suffix }) {
  const set = (d) => onSet(Math.max(min, Math.min(max, value + d)));
  return /* @__PURE__ */ React.createElement("span", { className: "home-step" }, /* @__PURE__ */ React.createElement("button", { onClick: () => set(-1), "aria-label": "\u043C\u0435\u043D\u044C\u0448\u0435" }, "\u2212"), /* @__PURE__ */ React.createElement("b", null, value, suffix), /* @__PURE__ */ React.createElement("button", { onClick: () => set(1), "aria-label": "\u0431\u043E\u043B\u044C\u0448\u0435" }, "+"));
}
function HCycle({ value, options, onPick }) {
  const i = Math.max(0, options.findIndex((o) => o.v === value));
  return /* @__PURE__ */ React.createElement("button", { className: "home-cycle", onClick: () => onPick(options[(i + 1) % options.length].v) }, (options[i] || options[0]).label);
}
function HRow({ label, children }) {
  return /* @__PURE__ */ React.createElement("div", { className: "home-row" }, /* @__PURE__ */ React.createElement("span", { className: "home-row-l" }, label), /* @__PURE__ */ React.createElement("span", { className: "home-row-c" }, children));
}
function fmtNum(n) {
...
function StatsPanel({ open, stats, onClose }) {
  const s = stats || {};
  return /* @__PURE__ */ React.createElement("aside", { className: "home-panel" + (open ? " open" : ""), "aria-hidden": !open }, /* @__PURE__ */ React.createElement("div", { className: "home-head" }, /* @__PURE__ */ React.createElement("span", { className: "home-head-t" }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("line", { x1: "18", y1: "20", x2: "18", y2: "10" }), /* @__PURE__ */ React.createElement("line", { x1: "12", y1: "20", x2: "12", y2: "4" }), /* @__PURE__ */ React.createElement("line", { x1: "6", y1: "20", x2: "6", y2: "14" })), "\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430"), /* @__PURE__ */ React.createElement("button", { className: "home-x", onClick: onClose, "aria-label": "\u0417\u0430\u043A\u0440\u044B\u0442\u044C" }, "\u2715")), /* @__PURE__ */ React.createElement("div", { className: "home-body" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec-h" }, "\u0422\u0435\u043A\u0443\u0449\u0438\u0439 \u0437\u0430\u043F\u0440\u043E\u0441"), /* @__PURE__ */ React.createElement("div", { className: "stat-big" }, /* @__PURE__ */ React.createElement("b", null, fmtNum(s.last_input)), /* @__PURE__ */ React.createElement("span", null, "\u0442\u043E\u043A\u0435\u043D\u043E\u0432 \u0443\u0445\u043E\u0434\u0438\u0442 \u043A\u0430\u0436\u0434\u044B\u0439 \u0440\u0430\u0437"))), /* @__PURE__ */ React.createElement("div", { className: "home-sec" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec-h" }, "\u0417\u0430 \u0441\u0435\u0441\u0441\u0438\u044E"), /* @__PURE__ */ React.createElement(HRow, { label: "\u0412\u0441\u0435\u0433\u043E \u0442\u043E\u043A\u0435\u043D\u043E\u0432" }, /* @__PURE__ */ React.createElement("span", { className: "stat-v" }, fmtNum(s.total))), /* @__PURE__ */ React.createElement(HRow, { label: "\u041A\u0435\u0448\u0438\u0440\u043E\u0432\u0430\u043D\u043E" }, /* @__PURE__ */ React.createElement("span", { className: "stat-v" }, fmtNum(s.cached))), /* @__PURE__ */ React.createElement(HRow, { label: "\u041F\u0440\u043E\u0446\u0435\u043D\u0442 \u043A\u0435\u0448\u0430" }, /* @__PURE__ */ React.createElement("span", { className: "stat-v" }, s.cached_pct != null ? s.cached_pct + "%" : "\u2014")))));
}
function HomePanel({ open, home, onPatch, onClose }) {
  ...
  return /* @__PURE__ */ React.createElement("aside", { className: "home-panel" + (open ? " open" : ""), "aria-hidden": !open }, /* @__PURE__ */ React.createElement("div", { className: "home-head" }, /* @__PURE__ */ React.createElement("span", { className: "home-head-t" }, /* @__PURE__ */ React.createElement("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M3 10.5L12 3l9 7.5" }), /* @__PURE__ */ React.createElement("path", { d: "M5 9.5V20a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9.5" }), /* @__PURE__ */ React.createElement("path", { d: "M9.5 21v-6h5v6" })), "\u0423\u043C\u043D\u044B\u0439 \u0434\u043E\u043C"), /* @__PURE__ */ React.createElement("button", { className: "home-x", onClick: onClose, "aria-label": "\u0417\u0430\u043A\u0440\u044B\u0442\u044C" }, "\u2715")), /* @__PURE__ */ React.createElement("div", { className: "home-body" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec-h" }, "\u041B\u044E\u0434\u0438"), Object.keys(people).map((name) => {
    const p = people[name] || {};
    return /* @__PURE__ */ React.createElement("div", { className: "home-person", key: name }, /* @__PURE__ */ React.createElement(HRow, { label: name }, /* @__PURE__ */ React.createElement(HSeg, { value: p.home ? "y" : "n", options: [{ v: "y", label: "\u0434\u043E\u043C\u0430" }, { v: "n", label: "\u043D\u0435 \u0434\u043E\u043C\u0430" }], onPick: (v) => onPatch({ people: { [name]: { home: v === "y" } } }) })), p.home ? /* @__PURE__ */ React.createElement("div", { className: "home-rooms" }, /* @__PURE__ */ React.createElement(HSeg, { value: p.room, options: HP_ROOMS, onPick: (v) => onPatch({ people: { [name]: { room: v } } }) })) : null);
  })), /* @__PURE__ */ React.createElement("div", { className: "home-sec" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec-h" }, /* @__PURE__ */ React.createElement("span", null, "\u041A\u043E\u043D\u0434\u0438\u0446\u0438\u043E\u043D\u0435\u0440"), /* @__PURE__ */ React.createElement(HSeg, { value: ac.on ? "y" : "n", options: [{ v: "y", label: "\u0432\u043A\u043B" }, { v: "n", label: "\u0432\u044B\u043A\u043B" }], onPick: (v) => onPatch({ ac: { on: v === "y" } }) })), ac.on ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(HRow, { label: "\u0422\u0435\u043C\u043F\u0435\u0440\u0430\u0442\u0443\u0440\u0430" }, /* @__PURE__ */ React.createElement(HStep, { value: ac.temp ?? 22, suffix: "\xB0", min: 16, max: 30, onSet: (v) => onPatch({ ac: { temp: v } }) })), /* @__PURE__ */ React.createElement(HRow, { label: "\u0420\u0435\u0436\u0438\u043C" }, /* @__PURE__ */ React.createElement(HCycle, { value: ac.mode, options: HP_AC_MODES, onPick: (v) => onPatch({ ac: { mode: v } }) })), /* @__PURE__ */ React.createElement(HRow, { label: "\u0412\u0435\u043D\u0442\u0438\u043B\u044F\u0442\u043E\u0440" }, /* @__PURE__ */ React.createElement(HSeg, { value: ac.fan, options: HP_FANS, onPick: (v) => onPatch({ ac: { fan: v } }) }))) : null), /* @__PURE__ */ React.createElement("div", { className: "home-sec" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec-h" }, "\u0422\u0443\u0430\u043B\u0435\u0442"), /* @__PURE__ */ React.createElement(HRow, { label: "\u0421\u0442\u0430\u0442\u0443\u0441" }, /* @__PURE__ */ React.createElement(HSeg, { value: toilet.occupied ? "y" : "n", options: [{ v: "y", label: "\u0437\u0430\u043D\u044F\u0442" }, { v: "n", label: "\u0441\u0432\u043E\u0431\u043E\u0434\u0435\u043D" }], onPick: (v) => onPatch({ toilet: { occupied: v === "y" } }) }))), /* @__PURE__ */ React.createElement("div", { className: "home-sec" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec-h" }, "\u0417\u0430 \u043E\u043A\u043D\u043E\u043C"), /* @__PURE__ */ React.createElement(HRow, { label: "\u0422\u0435\u043C\u043F\u0435\u0440\u0430\u0442\u0443\u0440\u0430" }, /* @__PURE__ */ React.createElement(HStep, { value: weather.temp ?? 0, suffix: "\xB0", min: -40, max: 50, onSet: (v) => onPatch({ weather: { temp: v } }) })), /* @__PURE__ */ React.createElement(HRow, { label: "\u041D\u0435\u0431\u043E" }, /* @__PURE__ */ React.createElement(HCycle, { value: weather.condition, options: HP_CONDS, onPick: (v) => onPatch({ weather: { condition: v } }) })), /* @__PURE__ */ React.createElement(HRow, { label: "\u0412\u0435\u0442\u0435\u0440" }, /* @__PURE__ */ React.createElement(HStep, { value: weather.wind ?? 0, suffix: " \u043C/\u0441", min: 0, max: 40, onSet: (v) => onPatch({ weather: { wind: v } }) }))), /* @__PURE__ */ React.createElement("div", { className: "home-sec" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec-h" }, "\u0422\u0435\u043C\u043F\u0435\u0440\u0430\u0442\u0443\u0440\u0430 \u0432 \u0434\u043E\u043C\u0435"), ["\u0441\u043F\u0430\u043B\u044C\u043D\u044F", "\u0433\u043E\u0441\u0442\u0438\u043D\u0430\u044F", "\u043A\u0443\u0445\u043D\u044F"].map((room) => /* @__PURE__ */ React.createElement(HRow, { key: room, label: cap(room) }, /* @__PURE__ */ React.createElement(HStep, { value: indoor[room] ?? 22, suffix: "\xB0", min: 10, max: 35, onSet: (v) => onPatch({ indoor: { [room]: v } }) })))), /* @__PURE__ */ React.createElement("div", { className: "home-sec" }, /* @__PURE__ */ React.createElement("div", { className: "home-sec-h" }, /* @__PURE__ */ React.createElement("span", null, "\u0420\u043E\u0431\u043E\u0442-\u043F\u044B\u043B\u0435\u0441\u043E\u0441"), /* @__PURE__ */ React.createElement(HSeg, { value: vac.on ? "y" : "n", options: [{ v: "y", label: "\u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442" }, { v: "n", label: "\u0441\u043F\u0438\u0442" }], onPick: (v) => onPatch({ vacuum: { on: v === "y" } }) })), vac.on ? /* @__PURE__ */ React.createElement(HRow, { label: "\u0420\u0435\u0436\u0438\u043C" }, /* @__PURE__ */ React.createElement(HSeg, { value: vac.mode, options: HP_VAC, onPick: (v) => onPatch({ vacuum: { mode: v } }) })) : null)));
}
...
function App() {
  ...
  const saveTavily = () => {
    ...
    setTavilyBusy(true);
    fetch("/api/services/tavily", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ key: tavilyKey.trim() }) }).then((r) => r.json()).then((s) => {
      setTavily(s);
      setTavilyKey("");
    }).catch(() => {
  ...
  const patchHome = (patch) => {
    ...
    fetch("/api/home", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(patch) }).then((r) => r.json()).then(setHome).catch(() => {
    });
  };
  ...
  async function handleSend(text) {
    ...
    const flush = () => {
      pending = false;
      setMessages((prev) => prev.some((m) => m.id === aId) ? prev.map((m) => m.id === aId ? { ...m, content: acc, searchLabel: null } : m) : [...prev, { id: aId, role: "assistant", content: acc, streaming: true, live: true }]);
    };
    const onDelta = (d) => {
      if (!d) return;
      acc += d;
    ...
    const onTool = (query) => {
      setMessages((prev) => prev.some((m) => m.id === aId) ? prev.map((m) => m.id === aId ? { ...m, searchLabel: query || "" } : m) : [...prev, { id: aId, role: "assistant", content: "", streaming: true, live: true, searchLabel: query || "" }]);
    };
    try {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "app" }, /* @__PURE__ */ React.createElement("header", { className: "hdr" }, /* @__PURE__ */ React.createElement("div", { className: "hdr-l" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "hdr-title" }, t.agentName))), /* @__PURE__ */ React.createElement("div", { className: "hdr-r" }, /* @__PURE__ */ React.createElement("button", { className: "ghost-btn" + (statsOpen ? " is-on" : ""), "aria-label": "\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430", title: "\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430", onClick: () => {
    ...
    setFadingTurns(/* @__PURE__ */ new Set());
    setInstantTurns(/* @__PURE__ */ new Set());
  } }, /* @__PURE__ */ React.createElement("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React.createElement("path", { d: "M3 6h18" }), /* @__PURE__ */ React.createElement("path", { d: "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" }), /* @__PURE__ */ React.createElement("line", { x1: "10", y1: "11", x2: "10", y2: "17" }), /* @__PURE__ */ React.createElement("line", { x1: "14", y1: "11", x2: "14", y2: "17" }))), /* @__PURE__ */ React.createElement("button", { className: "ghost-btn", "aria-label": "Settings", title: "Settings", onClick: () => {
